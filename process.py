...
eom_SPX = eom_prices['SPX_Index'] #.values #reset_index(drop=True)
eom_AGG = eom_prices['AGG_Index'] #.values #reset_index(drop=True)
shares_SPX = math.floor(init_equity * wgt_SPX / eom_SPX[0])
shares_AGG = math.floor(init_equity * wgt_AGG / eom_AGG[0])
